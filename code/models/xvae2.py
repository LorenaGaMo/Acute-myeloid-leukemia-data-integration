...
class XVAE:
    ...
    def build_model(self):
        ...
        # ------------ Out -----------------------
        s1_out = Dense(self.args.s1_input_size, )(x1)
        ...
        self.vae = Model(inputs, outputs, name='vae_x2')
        ...
        s1_loss= mean_squared_error(inputs[0], outputs[0])
    ...
    def train(self, s1_train, s2_train, s1_test, s2_test):
        ...
        if self.args.save_model:
            self.vae.save_weights('./models/vae_xvae2.h5')
